...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        function createProgressDiv(obj, s) {
            this.statusbar = $('<div class="ajax-file-upload-statusbar well well-sm"></div>').width(s.statusBarWidth);
            ...
            //this.abort = $("<div class='ajax-file-upload-red ajax-file-upload-abort text-warning" + obj.formGroup + "'>" + s.abortStr + "</div>").appendTo(this.statusbar).hide();
            this.abort = $("<span class='hide'></span>").appendTo(this.statusbar).hide();
            this.cancel = $("<div class='ajax-file-upload-red ajax-file-upload-cancel " + obj.formGroup + "'>" + s.cancelStr + "</div>").appendTo(this.statusbar)
                .hide();
            this.done = $("<div class='text-success upload-done'>" + s.doneStr + "</div>").appendTo(this.statusbar).hide();
