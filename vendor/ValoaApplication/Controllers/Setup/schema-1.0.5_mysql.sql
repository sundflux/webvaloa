...
/* 1.0.4 schema update */
ALTER TABLE `field`
ADD `default_value` varchar(255) NULL AFTER `id`,
ADD `validation` varchar(128) COLLATE 'utf8_general_ci' NULL COMMENT 'html5 validation regexp' AFTER `default_value`;

/* 1.0.5 schema update */

/**
 * Future-proofing for password_hash()
 */
ALTER TABLE `user`
